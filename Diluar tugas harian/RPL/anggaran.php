...
<body>
    <div class="app-layout">
        ...
        <aside class="sidebar" id="sidebar">
            <div class="sidebar-content">
                ...
                <nav class="nav-menu">
                    ...
                    <a href="anggaran.php?role=<?php echo $role; ?>" class="nav-item active"><i class="fa-solid fa-wallet"></i> <span>Kelola Anggaran</span></a>
        ...
        <div class="main-wrapper">
            ...
            <main class="content-area">
                <?php if($role === 'admin'): ?>
                <div class="form-card">
                    <h3 id="formTitle">Input Anggaran Dana Desa</h3>
                    <form id="formTransaction">
                        ...
                        <div style="display:flex; gap:10px;">
                            <button type="submit" id="btnSubmit" class="btn-submit">Simpan Anggaran</button>
                ...
                <div class="table-container">
                    <div class="table-header"><h3>Daftar Anggaran Masuk</h3></div>
                    <table class="main-table">
                        <thead>
                            <tr>
                                <th>Tanggal</th><th>Kegiatan</th><th>Kategori</th><th class="text-right">Jumlah</th>
    ...
    <script>
        ...
        function renderTable() {
            ...
            tbody.innerHTML = '';
            let filtered = db.filter(tx => tx.type === 'Anggaran').reverse();
            filtered.forEach(tx => {
                let action = isAdmin ? `
                    <td class="text-center">
                        <button class="btn-action edit" onclick="editData(${tx.id})" title="Edit"><i class="fa-solid fa-pen"></i></button>
                        <button class="btn-action delete" onclick="deleteData(${tx.id})" title="Hapus"><i class="fa-solid fa-trash"></i></button>
                    </td>` : '';
                tbody.innerHTML += `<tr><td>${tx.date}</td><td class="fw-600">${tx.name}</td><td><span class="tag-category">${tx.cat}</span></td><td class="text-right fw-600">${formatRp(tx.amount)}</td>${action}</tr>`;
            });
        }
        ...
        window.editData = function(id) {
            ...
            if(item) {
                ...
                document.getElementById('formTitle').innerText = "Edit Data Anggaran";
                document.getElementById('btnSubmit').innerText = "Update Anggaran";
        ...
        window.resetForm = function() {
            ...
            document.getElementById('formTitle').innerText = "Input Anggaran Dana Desa";
            document.getElementById('btnSubmit').innerText = "Simpan Anggaran";
